...
function jimmy_editor_admin() {
	wp_enqueue_style( 'jimmy-editor-admin-style',  plugins_url( 'style-jimmy-editor-admin.css', __FILE__ ), array(), '1.0.2' );
	wp_enqueue_script( 'jimmy-editor-admin-script-patch',  plugins_url( 'js/post-editor-patch.min.js', __FILE__ ), array(), '1.0.2', true );
	wp_enqueue_script( 'jimmy-editor-admin-script',  plugins_url( 'js/script-jimmy-editor-admin.min.js', __FILE__ ), array(), '1.0.2', true );
	return true;
}
